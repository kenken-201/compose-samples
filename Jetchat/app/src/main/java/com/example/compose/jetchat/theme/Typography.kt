...
val MontserratFontFamily = FontFamily(
    ...
    androidx.compose.ui.text.font.Font(R.font.montserrat_light, weight = FontWeight.Light),
    ...
    androidx.compose.ui.text.font.Font(R.font.montserrat_semibold, weight = FontWeight.SemiBold),
)

@OptIn(ExperimentalTextApi::class)
val KarlaFontFamily = FontFamily(
    Font(googleFont = KarlaFont, fontProvider = provider),
    androidx.compose.ui.text.font.Font(R.font.karla_regular),
    Font(googleFont = KarlaFont, fontProvider = provider, weight = FontWeight.Bold),
    androidx.compose.ui.text.font.Font(R.font.karla_bold, weight = FontWeight.Bold),
)
